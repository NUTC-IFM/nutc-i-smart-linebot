            ...
            contents={
                ...
                "hero": {
                    ...
                    "contents": [
                        {
                            "type": "image",
                            "url": "https://i.imgur.com/xn6DBGB.png",
                            "align": "center",
                            "size": "full",
                            "gravity": "center"
                        },
            ...
            contents={
                ...
                "hero": {
                    ...
                    "contents": [
                        {
                            "type": "image",
                            "url": "https://i.imgur.com/Ppg4X01.png",
                            "align": "center",
                            "size": "full",
                            "gravity": "center"
                        },
            ...
            contents={
                ...
                "hero": {
                    ...
                    "contents": [
                        {
                            "type": "image",
                            "url": "https://i.imgur.com/i8Q4gWx.png",
                            "align": "center",
                            "size": "full",
                            "gravity": "center"
                        },
    ...
    def result_button(check_data, event):
        ...
        for i in range(len(advice)):
            contents = {
                ...
                "height": "sm",
                "style": "primary",
                "color": "#CECF52" if event.message.text == "人生保險規劃紀錄" else "#EF7385"
            }
        ...
        advice_button = {
            ...
            "hero": {
                ...
                "contents": [
                    {
                        "type": "image",
                        "url": "https://i.imgur.com/i8Q4gWx.png" if event.message.text == "人生保險規劃紀錄" else "https://i.imgur.com/pIIAHwT.png",
                        "align": "center",
                        "size": "full",
                        "gravity": "center"
                    },
    ...
    def result_button2(check_data, event):
        ...
        for i in range(len(advice)):
            contents = {
                ...
                "height": "sm",
                "style": "primary",
                "color": "#81C25E" if event.message.text == "人生保險規劃紀錄" else "#EF7385"
            }
            data_list.append(dict(contents))
        ...
        advice_button = {
            ...
            "hero": {
                ...
                "contents": [
                        {
                            "type": "image",
                            "url": "https://i.imgur.com/pIIAHwT.png",
                            "align": "center",
                            "size": "full",
                            "gravity": "center"
                        },
...
class Life_stage2():
    ...
    def reply_result(line_bot_api, event):
        ...
        myReply = Result_template(myReply).content(
            "人生保險規劃 退休規劃紀錄", "https://i.imgur.com/pIIAHwT.png")
